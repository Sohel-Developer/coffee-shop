        ...
        <div className="banner  py-60 ">
            <div className="max-w-7xl mx-auto">
                <div className="  text-white ms-auto space-y-4 px-5 md:w-3/5">
                    ...
                    <p className="font-raleway">It is coffee time - Sip & Savor - Relaxation in every sip! Get the nostalgia back!! <br /> Your companion of every moment!!! Enjoy the beautiful <br /> moments and make them memorable.</p>
